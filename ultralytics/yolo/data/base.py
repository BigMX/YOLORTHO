...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        self.im_files, self.label_files = self.get_img_files(self.img_path)
        ...
        self.load_transforms = self.build_load_transforms(hyp=hyp)
    ...
    def get_img_files(self, img_path):
        ...
        try:
            ...
            if ' ' in f[0]:
                ...
                im_files = [x[0] for x in f]
                label_files = [x[1] for x in f]
            else:
    ...
    def get_label_info(self, index):
        ...
        label = self.load_transforms(label)
        return label
